...
const T = {
  es: {
    ...
    proj_aura_title: 'AURA - Asistente Unificado de Respuesta Avanzada',
    ...
    proj_button_official: '<i class="fas fa-external-link-alt"></i> Sitio Oficial',
    ...
    proj5_title: 'Ya Pagué!',
    proj5_desc: 'App de finanzas personales con IA. Registrá gastos escribiendo en lenguaje natural, dictando por voz o subiendo una foto de un ticket.',
    proj11_title: 'Vision Lab',
    proj11_desc: 'Web para uso de modelos en Computer Vision. Subís un video, elegís un modelo, ajustás los parámetros y obtenés el video listo!',
    proj11_btn: '<i class="fas fa-spinner"></i> V2 en progreso',
    proj10_title: 'E-commerce - Testing &amp; QA',
    proj10_desc: 'E-commerce con múltiples bugs, sobre la cual se aplicaron ciclos de testing, identificación de fallos y correcciones en el marco de la materia "Testing".',
    ...
    proj8_title: 'Arrayanes - Rent a Car',
    proj8_desc: 'Landing page para empresa de alquiler de autos. Permite buscar y reservar autos, mediante integración con whatsapp. (Primera versión del sitio)',
    proj9_title: 'Resumen de reuniones',
    proj9_desc: 'App que transcribe audio de reuniones y genera un resumen estructurado con decisiones tomadas y próximos pasos, usando Whisper y Claude AI.',
    proj12_title: 'Crocolab - Impresión 3D',
    proj12_desc: 'Sitio web para un emprendimiento de impresión 3D. Catálogo de productos, pedidos personalizados y gestión de clientes, con panel de administración.',
    proj12_btn: '<i class="fas fa-spinner"></i> En desarrollo',
    proj13_title: 'Impacto - App de Gimnasio',
    proj13_desc: 'App móvil para la gestión integral de un gimnasio. Seguimiento de rutinas, control de asistencia, pagos y comunicación directa con el equipo.',
    proj13_btn: '<i class="fas fa-spinner"></i> En desarrollo',
    proj14_title: 'Sitio Periodístico',
    proj14_desc: 'Landing personal para periodismo. Portfolio de publicaciones, entrevistas, crónicas e investigaciones con estética editorial impresa.',
  ...
  en: {
    ...
    proj_aura_title: 'AURA - Advanced Unified Response Assistant',
    ...
    proj_button_official: '<i class="fas fa-external-link-alt"></i>   Official Site',
    ...
    proj11_title: 'Vision Lab',
    proj11_desc: 'Web for use of models in Computer Vision. You upload a video, choose a model, adjust the parameters and get the video ready!',
    proj11_btn: '<i class="fas fa-spinner"></i> V2 in progress',
    proj10_title: 'E-commerce - Testing &amp; QA',
    ...
    proj8_title: 'Arrayanes - Rent a Car',
    proj8_desc: 'Landing page for a car rental company. Allows searching and booking cars through WhatsApp integration. (First version of the site)',
    proj9_title: 'Meeting Summarizer',
    proj9_desc: 'App that transcribes meeting audio and generates a structured summary with decisions made and next steps, using Whisper and Claude AI.',
    proj12_title: 'Crocolab - 3D Printing',
    proj12_desc: 'Website for a 3D printing business. Product catalog, custom orders and customer management, with its own admin panel.',
    proj12_btn: '<i class="fas fa-spinner"></i> In development',
    proj13_title: 'Impacto - Gym App',
    proj13_desc: 'Mobile app for full gym management. Routine tracking, attendance control, payments and direct communication with the team.',
    proj13_btn: '<i class="fas fa-spinner"></i> In development',
    proj14_title: 'Sports Journalism Site',
    proj14_desc: 'Personal landing for a journalist. Portfolio of articles, interviews, chronicles and investigations with a printed editorial aesthetic.',
    proj14_btn: '<i class="fas fa-external-link-alt"></i> Sitio Oficial',
